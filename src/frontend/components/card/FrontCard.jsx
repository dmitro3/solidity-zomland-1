...
export const FrontCard = ({
    ...
    const CharacteristicRow = ({ icon, title, value }) => (
      <Row className="justify-center">
        <div className={`${size === "sm" ? "h-7 w-7 " : "h-9 w-9 "} flex p-1.5 border-violet-500 rounded-full border-2 text-center justify-center bg-main`}>
                    ...
                    <Button
                      title={
                        <>
                          ...
                          {nft.salePrice} {process.env.TOKEN_NAME}
                        </>
                      }
                      className="mt-2"
                      size="xs"
