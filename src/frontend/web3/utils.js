...
export const transformZombie = (zombie) => {
  return {
    ...
    salePrice: parseInt(zombie.salePrice) ? convertFromYocto(zombie.salePrice, 3) : null,
...
export const transformMonster = (monster) => {
  return {
    ...
    salePrice: parseInt(monster.salePrice) ? convertFromYocto(monster.salePrice, 3) : null,
